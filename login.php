...
try {
    ...
    //Recipients
    $mail->setFrom('pioc@gmail.com', 'PIOC System');
    $mail->addAddress('raqhinkusmanadinata@gmail.com', 'Raqhin K');     //Add a recipient
    $mail->addReplyTo('pioc@gmail.com', 'PIOC System');

    //Attachments
    $mail->addAttachment('images/logopioc.png', "PIOC System");         //Add attachments
