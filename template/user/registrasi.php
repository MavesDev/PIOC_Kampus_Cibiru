<div class="account-home-btn d-none d-sm-block">
    <a href="landing_page.php" class="text-primary"><i class="mdi mdi-home h1"></i></a>
</div>
                                        ...
                                        <div class="col-lg-11">
                                            <div class="p-4">
                                                <div class="text-center mt-3">
                                                    <a href="landing_page.php"><img src="images/logopioc.png" alt=""
                                                            height="60"></a>
                                                    ...
                                                    <form action="php/register.php" method="post">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="nama_user"
                                                                name="nama_user" placeholder="username">
                                                        </div>
                                                        ...
                                                        <div class="mt-4 mb-0 text-center">
                                                            <p class="mb-0">already have an account ? <a
                                                                    href="login.php" class="text-success">Log in</a>
                                                            </p>
                                                        </div>
                                                    </form>
                                                </div>
