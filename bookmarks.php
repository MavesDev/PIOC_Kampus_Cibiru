                    ...
                    while ($bookmark = $result->fetch_assoc()) { ?>
                        <div class="col-lg-4" id="container-post">
                            <div class="services-box p-4 mt-4">
                                ...
                                <a href="post.php?id_post=<?= htmlspecialchars($bookmark['id_postingan']); ?>" class="text-primary f-4" title="View Post">
                                    <i class="fas fa-eye"></i> View Post
                                </a>
                                <a href="php/bookmark.php?action=unbookmark&id_post=<?= $bookmark['id_postingan'] ?>" class="btn btn-danger">Unbookmark</a>
                            </div>
                        </div>
                    <?php }
                } else { ?>
